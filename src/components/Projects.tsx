  ...
  const projects = [
    {
      ...
      description: "A real-time collaborative whiteboard application with multi-user cursor rendering, drawing tools, snapping features, and smart alignment guides. Built for seamless team collaboration.",
    ...
    },
    {
      ...
      description: "A scalable e-commerce platform featuring secure authentication, payment processing, and optimized performance. Deployed on Vercel for fast, reliable user experience.",
    ...
    },
    {
      ...
      description: "A comprehensive Learning Management System with role-based dashboards, interactive course tracking, and secure video streaming for seamless online learning.",
    ...
    },
    {
      ...
      description: "A full-featured social media platform with Instagram-like functionality, real-time chat, and advanced media management through Cloudinary integration.",
